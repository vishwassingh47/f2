...
public class rootFrame5 extends Fragment
{
    private final int pageIndex=5;
    private final int frameId=R.id.root_frameLayout5;
    private final int frameLayoutId=R.layout.layoutof_rootframe5;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        Log.e("ROOT5:",pageName+"--"+currentPagePath);
