...
/**
 * Created by hit4man47 on 10/7/2017.
 */


public class rootFrame4 extends Fragment
{
    private final int pageIndex=4;
    private final int frameId=R.id.root_frameLayout4;
    private final int frameLayoutId=R.layout.layoutof_rootframe4;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        Log.e("ROOT4:",pageName+"--"+currentPagePath);
