...
public class rootFrame3 extends Fragment
{
    private final int pageIndex=3;
    private final int frameId=R.id.root_frameLayout3;
    private final int frameLayoutId=R.layout.layoutof_rootframe3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        Log.e("ROOT3:",pageName+"--"+currentPagePath);
