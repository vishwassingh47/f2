...
public class RootShell {
     ...
     */
    public static boolean exists(final String file)         //OK
    {
     ...
     * @return a boolean that will indicate whether or not the file exists.
     */
    public static boolean exists(final String file, boolean isDir)      //OK
    {
        final List<String> result = new ArrayList<String>();
        String cmdToExecute = "ls " + (isDir ? "-d " : " ");

        //first tying without Root
     ...
     */
    public static List<String> findBinary(String binaryName, boolean singlePath)    //OK
    {
    ...
    public static List<String> findBinary(final String binaryName, List<String> searchPaths, boolean singlePath) {
        ...
        try
        {
            ...
            {
                final String currentPath = path;//to add to list
        ...
        if (!found)
        {
            ...
            for (String path : searchPaths)
            {
                ...
                {
                    RootShell.log(binaryName + " was NOT found here: " + currentPath);
                }
            }
        }
     ...
     */
    public static List<String> getPath()            //OK
    {
