...
public class rootFrame0 extends Fragment
{
    ...
    private final int frameId=R.id.root_frameLayout0;
    private final int frameLayoutId=R.layout.layoutof_rootframe0;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        Log.e("ROOT0:",pageName+"--"+currentPagePath);
