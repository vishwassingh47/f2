...
public class rootFrame1 extends Fragment
{
    private final int pageIndex=1;
    private final int frameId=R.id.root_frameLayout1;
    private final int frameLayoutId=R.layout.layoutof_rootframe1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        Log.e("ROOT1:",pageName+"--"+currentPagePath);
