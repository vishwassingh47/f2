...
public class CopyData
{
    ...
    public  boolean isFastMove=false;
    ...
    public boolean getTinyDbData(TinyDB tinyDB)
    {
        ...
        if(isDataAvailable)
        {
            isFastMove=tinyDB.getBoolean(code+"isFastMove");
    ...
    public void getPasterDataAndResetPasterAndTinyDB(TinyDB tinyDB)
    {
        ...
        isFastMove=PasteClipBoard.isFastMove;
        ...
        tinyDB.putBoolean(code+"isFastMove",isFastMove);
